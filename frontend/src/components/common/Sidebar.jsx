    ...
    <div className='bg-white shadow-sm border-r border-gray-200 w-64 min-h-screen p-4'>
        ...
        <nav className='space-y-1'>
            ...
            <button
                ...
                className='cursor-pointer flex items-center w-full px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 text-gray-600 hover:bg-gray-50 hover:text-gray-900 mt-4'
            >
